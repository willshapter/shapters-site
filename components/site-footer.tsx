      ...
      <div className="mx-auto max-w-7xl px-4 space-y-10">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-bold uppercase tracking-wider text-white">Sobre a Shapters</h4>
        ...
        {/* PARTE INFERIOR: TODAS AS REDES SOCIAIS E BANDEIRAS COLORIDAS */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 text-xs">
          
          {/* Redes Sociais Completas */}
          <div className="flex items-center space-x-2.5">
            <span className="font-semibold text-white mr-1">Siga-nos</span>
            ...
            {/* Instagram */}
            <a href="#" aria-label="Instagram" className="flex h-8 w-8 items-center justify-center rounded-full bg-pink-600 text-white shadow-sm hover:opacity-90 transition-opacity">
